...
describe('Component HappyHourAdd', () => {
  ...
  it('should render with title from mockProps', () => {
...
describe('Component HappyHourAd with mocked Date in promo time', () => {
  ...
  checkDescriptionAtTime('12:47:24', mockProps.promoDescription);
  checkDescriptionAtTime('12:59:59', mockProps.promoDescription);
});

describe('Component HappyHourAd with mocked Date, delay checking passing 12:00', () => {
  checkDescriptionAfterTime('11:59:58', 1, '1');
